...
np.save('exit_x',np.array([]))
np.save('exit_y',np.array([]))
np.save('exit_z',np.array([]))
np.save('timer',np.array([]))
np.save('counter',counter)
np.save('Vecx',np.zeros(100))
np.save('Vecy',np.zeros(100))
np.save('Vecz',np.zeros(100))
np.save('Vecx2',np.zeros(100))
np.save('Vecy2',np.zeros(100))
np.save('Vecz2',np.zeros(100))
