...
bar, fig = plt.subplots(figsize=(11,5))
...
ax0.plot(x_mem,y_mem,color='black',linewidth=3)
ax0.plot(x_mem_2,y_mem,color='black',linewidth=3)
...
ax1.plot(x_mem,y_mem,color='black',linewidth=3)
ax1.plot(x_mem_2,y_mem,color='black',linewidth=3)
